...
IMAGE_PATH = os.path.join(paths['IMAGE_PATH'], 'test', 'thumbsup.8dd8baac-2e25-11ed-b7ea-70a8d3e8cae6.jpg')
...
# For some reason Line 8 reverts the matplotlib.get_backend() back to 'agg' which renders the plt.show() useless
